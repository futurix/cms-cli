namespace Wave.Common
{
    public class Blowfish
    {
        ...
        /// <summary>
        /// Constructs and initializes an instance with the supplied key.
        /// </summary>
        ...
        public void Encrypt(byte[] data, int length)
        {
            ...
            int remainderLength = length % 8;
            int validLength = length - remainderLength;
            ...
            // encrypting remainder
            if (remainderLength != 0)
                EncryptRemainder(data, validLength, remainderLength);
        }
        ...
        /// <summary>
        /// Non-standard basic encryption for the rest of the data.
        /// </summary>
        private void EncryptRemainder(byte[] src, int srcIndex, int length)
        {
            byte encByte = 0xD1;
            length += encByte;

            for (; encByte < length; ++encByte)
            {
                src[srcIndex] ^= encByte;
                ++srcIndex;
            }
        }
        ...
        public void Decrypt(byte[] data, int length)
        {
            ...
            // decrypting remainder (if any)
            if (remainderLength != 0)
                DecryptRemainder(data, validLength, remainderLength);
        }
        ...
        /// <summary>
        /// Non-standard basic decryption for the rest of the data.
        /// </summary>
        private void DecryptRemainder(byte[] src, int srcIndex, int length)
        {
            byte i = 0xD1;
            int last = i + length;
